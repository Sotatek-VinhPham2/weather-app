...
function App() {
    ...
    <input type='text' className='search' placeholder='Enter your city' value={query}/** Direct State ge Query Send Madadhu*/ onChange={(e)=> setQuery(e.target.value)} onKeyPress={search}></input>
    {weather.main && (
      <div className="city">
